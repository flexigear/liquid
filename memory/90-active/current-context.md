...
- Which engine and simulation stack will be used for the first prototype.
- How far to push realism on mobile versus desktop targets.
- Whether the first simulation pass uses full 3D fluid particles or a constrained approximation.

## Suggested Next Tasks

- Choose engine and rendering path.
- Define the first fluid simulation architecture.
- Build the trackball container prototype shell.
